  ...
  return (
    <div className="flex flex-row  justify-items-center h-screen text-[#121212] dark:text-white dark:bg-[#242424]">
      ...
      <div className="w-7/12 p-20 flex justify-center">
        <div className="w-3/5 px-10 flex flex-col justify-center space-y-10 bg-white dark:bg-[#121212] rounded-2xl login-banner-shadow">
          <div className="mx-10">
            <img
              src={
          ...
          <div
            className="flex flex-row justify-end hover:underline"
            onClick={() => {
